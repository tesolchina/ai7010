#!/usr/bin/env python3
"""
LLM-based OCR script for the first 3 pages of a PDF file.
...
def process_pdf_with_llm(pdf_path, output_path, log_file="progress.log"):
    """
    Process the first 3 pages of a PDF using LLM vision model.
    ...
    with open(log_file, 'w', encoding='utf-8') as f:
        f.write(f"{'='*60}\n")
        f.write(f"LLM OCR Processing Log\n")
        f.write(f"{'='*60}\n\n")
    ...
    try:
        ...
        log_progress(f"Processing first {pages_to_process} pages", log_file)
        
        # Prepare output content
        output_lines = []
        output_lines.append(f"# LLM OCR Output from {os.path.basename(pdf_path)}\n\n")
        output_lines.append(f"**Extracted from First 3 Pages using Qwen-2.5-72b VL**\n\n")
...
if __name__ == "__main__":
    ...
    output_path = "/Users/simonwang/Documents/Usage/ai7010/lab3/3pagesLLM.md"
    log_file = "/Users/simonwang/Documents/Usage/ai7010/lab3/llm_ocr_progress.log"
    ...
    success = process_pdf_with_llm(pdf_path, output_path, log_file)
